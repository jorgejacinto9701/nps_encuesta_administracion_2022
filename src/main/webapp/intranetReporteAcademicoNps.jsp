...
<div class="container" style="padding-top: 5%">
		 ...
		 <div class="col-md-12" >
		       ...
		       <form  action="reporteAcademicoNpsExcel" class="fileDownloadForm"  method="post">
				<div class="row">
						<div class="col-md-6">
							<h5><b>Reporte de Avance NPS Académico</b></h5><br>
						</div>
				</div>
				<div class="row">
  			...
  			<div class="col-md-12" >
		       ...
		       <form  action="listadoAcademicoNpsExcel" class="fileDownloadForm"  method="post">
				<div class="row">
						<div class="col-md-6">
							<h5><b>Listado de NPS Académico</b></h5><br>
						</div>
				</div>
				<div class="row">
